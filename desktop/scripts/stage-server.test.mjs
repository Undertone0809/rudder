...
function createStageServerRepo() {
  ...
  writeFileSync(pnpmFixturePath, [
    ...
    "  const required = ['--offline', '--frozen-lockfile'];",
    "  if (process.platform !== 'win32') required.push('--force');",
    "  if (process.platform === 'win32' && process.argv.includes('--force')) process.exit(47);",
