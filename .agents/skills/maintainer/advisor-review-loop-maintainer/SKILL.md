...
Run a decision-grade advisor-to-reviewer loop for Rudder work that should not be accepted after one author pass.
...
```text
evidence packet -> advisor pass -> reviewer agents -> rework list -> second review -> final handoff
```
