...
- `doc/engineering/RELEASING.md` for the main maintainer runbook.
- `doc/engineering/PUBLISHING.md` for npm/package internals.
- `doc/engineering/RELEASE-AUTOMATION-SETUP.md` for one-time GitHub/npm setup.
