...
```json
{"type":"item.completed","item":{"type":"mcp_tool_call","server":"rudder-control-plane","tool":"rudder_agent_me"}}
```

Server-qualified tool names may appear as:

- `rudder-control-plane_rudder_agent_me`
- `rudder-control-plane_rudder_issue_context`
- `rudder-control-plane_rudder_issue_checkout`
- `rudder-control-plane_rudder_issue_comment`
- `rudder-control-plane_rudder_issue_done`
