...
```json
{
  ...
  "message": {
    "content": [
      {"type": "tool_use", "name": "mcp__rudder-tools__rudder_agent_me"},
...
- `mcp__rudder-tools__rudder_agent_me`
- `mcp__rudder-tools__rudder_issue_context`
- `mcp__rudder-tools__rudder_issue_checkout`
- `mcp__rudder-tools__rudder_issue_comment`
- `mcp__rudder-tools__rudder_issue_done`
...
- expected `mcp__rudder-tools__...` tool uses
- no `Bash` fallback for Rudder work
