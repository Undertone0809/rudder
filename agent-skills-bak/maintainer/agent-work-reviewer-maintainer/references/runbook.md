# agent-work-reviewer-maintainer Runbook
...
- `doc/product/README.md` plus relevant `doc/product/domains/**`
- `doc/engineering/DESIGN.md` for visible UI and interaction work
...
- Read `doc/engineering/DESIGN.md` before judging.
