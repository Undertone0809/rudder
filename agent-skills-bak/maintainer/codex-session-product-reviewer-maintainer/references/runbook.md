# codex-session-product-reviewer-maintainer Runbook
...
4. Read the relevant product context.
   - Start with `doc/product/GOAL.md`, `doc/product/PRODUCT.md`, `doc/product/README.md` plus relevant `doc/product/domains/**`,
