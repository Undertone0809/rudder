...
- Goal Workspace public Outcome, progress, Agent activity, next step, Feedback,
  Focus, History, Completion Proposal, Owner, and linked work, plus the
  underlying Contract/Proof governance: `ORG.GOAL.001`.
