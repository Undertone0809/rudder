...
| --- | --- | --- | --- |
| `dashboard-Rudder` | Dashboard | The organization is alive and legible | hero or top feature |
...
- Would a new visitor understand that Rudder is a shared workspace, not a generic chat app?
