...
Separate **Rudder** from **execution runtime** more explicitly:
...
Keep the Rudder core thin; put optional high-variance experiences into plugins.
...
- **Keep** Rudder as the board-level Rudder.
