...
- installed adapter list for this Rudder instance
...
Extend `ServerAgentRuntimeModule` contract to expose config docs:
...
## 8. New Skill: `rudder-create-agent`

Create new skill directory:

- `skills/rudder-create-agent/SKILL.md`
- `skills/rudder-create-agent/references/api-reference.md`
...
Also update `skills/rudder/SKILL.md` to reference this skill for hiring workflows.
...
- `rudder-create-agent` skill + docs updates
