...
Rudder should move agent Rudder work away from shell-first `rudder`
...
- Codex local run `91d46da7-40de-4ad7-8192-1a8dd47bf568` used
  `rudder-tools` MCP tools to run `rudder_issue_context`,
...
- Direct transcript inspection found no shell `rudder ...` command executions
  in either accepted run; the Rudder writes came through MCP tool calls.
