...
- `skills/rudder/SKILL.md` and `skills/rudder/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/rudder-create-agent/SKILL.md`
