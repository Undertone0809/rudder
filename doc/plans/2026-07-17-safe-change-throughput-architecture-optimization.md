...
1. **Behavior safety:** product and control-plane invariants remain explicit,
...
### Phase 3: Execution And Control-Plane Ownership
...
- keep Desktop and CLI as adapters over shared lifecycle contracts rather than
  alternate owners of control-plane policy.
...
Rudder stays in one deployable control-plane process by default:
