...
This is intentionally separate from the normal Rudder dev image.
...
```sh
review-checkout-pr rudder/rudder 432
cd /work/checkouts/rudder-rudder/pr-432
```
...
## Preview the Rudder app from the PR
...
- Rudder's embedded PostgreSQL and local storage stay inside the container home volume via `RUDDER_HOME=/home/reviewer/.rudder-review`.
