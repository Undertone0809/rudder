...
```bash
"${RUDDER_CLI:-rudder}" library file get "docs/<issue-identifier>-plan.md" --json
"${RUDDER_CLI:-rudder}" library file put "docs/<issue-identifier>-plan.md" --body-file "<path>" --json
