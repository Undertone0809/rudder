...
| `rudder_browser_download` | `rudder browser download <tab-id> --input <json>` | Download explicit locator media or trigger one bounded run-owned Browser download. | yes | required | required | required |
