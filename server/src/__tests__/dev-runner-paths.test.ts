...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Rudder state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".rudder/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/rudder",
      ),
    ).toBe(false);
