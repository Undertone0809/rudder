...
describe("log redaction", () => {
  it("redacts the active username inside home-directory paths", () => {
    ...
    const input = [
      `cwd=/Users/${userName}/rudder`,
      `home=/home/${userName}/workspace`,
      `win=C:\\Users\\${userName}\\rudder`,
    ].join("\n");
    ...
    expect(result).toContain(`cwd=/Users/${maskedUserName}/rudder`);
    expect(result).toContain(`home=/home/${maskedUserName}/workspace`);
    expect(result).toContain(`win=C:\\Users\\${maskedUserName}\\rudder`);
  ...
  it("recursively redacts nested event payloads", () => {
    ...
    const result = redactCurrentUserValue({
      cwd: `/Users/${userName}/rudder`,
      prompt: `open /Users/${userName}/rudder/ui`,
      nested: {
        author: userName,
      },
    ...
    expect(result).toEqual({
      cwd: `/Users/${maskedUserName}/rudder`,
      prompt: `open /Users/${maskedUserName}/rudder/ui`,
      nested: {
  ...
  it("skips redaction when disabled", () => {
    const input = "cwd=/Users/paperclipuser/rudder";
