  ...
  it.skipIf(process.platform === "win32")(
    ...
    async () => {
      ...
      try {
        ...
        expect(meta.rudderNativeTools).toMatchObject({ available: true, serverName: "rudder-tools", toolCount: 72 });
  ...
  it.skipIf(process.platform === "win32")(
    ...
    async () => {
      ...
      try {
        ...
        expect(meta.rudderNativeTools).toMatchObject({ toolCount: 72 });
