...
/**
 * Generate the README.md content for a organization export.
 */
export function generateReadme(
  ...
  lines.push("");
  if (options.organizationDescription) {
    lines.push(`> ${options.organizationDescription}`);
    lines.push("");
  }
  ...
  lines.push("");
  lines.push("> This is an [Agent Organization](https://agentorganizations.io) package from [Rudder](https://github.com/Undertone0809/rudder)");
  lines.push("");
