/**
 * @fileoverview Approval lifecycle service for governed actions, comments,
 * hire-agent activation, budget setup, and decision records.
 *
 * @see doc/product/domains/governance-and-visibility/approvals-budgets-activity.md - approval gates and activity evidence
    ...
    approve: async (
      ...
      if (applied && updated.type === "hire_agent") {
        ...
        if (payloadAgentId) {
          ...
          const created = await agentsSvc.create(updated.orgId, {
            ...
            agentRuntimeConfig:
              typeof payload.agentRuntimeConfig === "object" && payload.agentRuntimeConfig !== null
                ? (payload.agentRuntimeConfig as Record<string, unknown>)
                : {},
            budgetMonthlyCents:
      ...
      return db
        ...
        .where(
          and(
            ...
            eq(approvalComments.orgId, existing.orgId),
          ),
        )
