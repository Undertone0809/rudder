...
export const NETWORK_WAIT_BACKOFF_MS = [2_000, 5_000, 10_000, 20_000, 30_000, 60_000] as const;
export const NETWORK_WAIT_MAX_ATTEMPTS = NETWORK_WAIT_BACKOFF_MS.length;
export const NETWORK_WAIT_EXHAUSTED_ERROR_CODE = "network_retry_exhausted" as const;
...
export const heartbeatRunListColumns = {
  ...
  runningSubstate: heartbeatRuns.runningSubstate,
  ...
  networkWaitNextRetryAt: heartbeatRuns.networkWaitNextRetryAt,
  networkWaitAttemptCount: heartbeatRuns.networkWaitAttemptCount,
  networkWaitDurationMs: heartbeatRuns.networkWaitDurationMs,
  recoveryCheckpoint: heartbeatRuns.recoveryCheckpoint,
