...
let cached: { keyFingerprint: string; expiresAt: number; models: AgentRuntimeModel[] } | null = null;
...
async function fetchOpenAiModels(apiKey: string): Promise<AgentRuntimeModel[]> {
