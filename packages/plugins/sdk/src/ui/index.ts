/**
 * `@rudder/plugin-sdk/ui` — Rudder plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@rudder/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@rudder/plugin-sdk/ui";
 *
 ...
 *       <button onClick={() => resync({ orgId: context.orgId })}>
 *         Resync Now
 *       </button>
 *     </div>
 *   );
