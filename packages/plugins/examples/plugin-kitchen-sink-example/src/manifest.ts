...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Rudder plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Rudder",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current organization using the Rudder domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
