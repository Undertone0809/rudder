...
Or install it from the Rudder plugin manager as a bundled example once this repo is built.
...
- Some SDK-defined host surfaces still depend on the Rudder host wiring them visibly; this package aims to exercise the currently mounted ones and make the rest obvious.
