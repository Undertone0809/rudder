...
export type {
  ...
  GoalActivity, GoalAgentContext, GoalAgentListLifecycle, GoalAgentListResponse, GoalChangeProposal, GoalContinuation, GoalContractPatch, GoalContractSnapshot, GoalCriterion, GoalDependencies,
