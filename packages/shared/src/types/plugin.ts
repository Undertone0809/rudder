...
export interface PluginUiSlotDeclaration {
  ...
  /**
   * Optional organization-scoped route segment for page slots.
   * Example: `kitchensink` becomes `/:organizationPrefix/kitchensink`.
   */
  routePath?: string;
  /**
...
/**
 * Lower-bound semver requirement for the Rudder host.
 *
