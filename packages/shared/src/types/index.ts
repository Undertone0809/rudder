...
export type {
  ...
  GoalChangeProposal, GoalCheckpoint, GoalCheckpointContinuation, GoalCheckpointInput, GoalContinuation,
  GoalContractPatch,
  GoalContractSnapshot,
  GoalCriterion,
  GoalDependencies,
  GoalDependencyPreview, GoalEvaluationCandidate, GoalEvidenceItem, GoalFeedbackAttachment,
  GoalFeedbackEntry, GoalHistoryAttachment,
  GoalHistoryItem,
  GoalHistoryPage,
  GoalOwnerAssignment,
  GoalPlan, GoalPlanPayload, GoalResultProposal,
