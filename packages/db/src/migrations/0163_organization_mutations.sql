...
-- This append-only migration preserves the existing Node migration authority.
...
--> statement-breakpoint
ALTER TABLE "organization_mutation_receipts" ADD CONSTRAINT "organization_mutation_receipts_org_id_organization_mutation_state_org_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organization_mutation_state"("org_id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "organization_mutation_receipts" ADD CONSTRAINT "organization_mutation_receipts_activity_fk" FOREIGN KEY ("org_id","activity_id") REFERENCES "public"."activity_log"("org_id","id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
-- Preserve the existing Node activity-first, organization-last delete transaction.
