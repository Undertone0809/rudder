...
export const RUDDER_AGENT_CONTRACT = {
  ...
  "capabilities": [
    ...
    },
    {
      "api": {
        "method": "PATCH",
        "pathTemplate": "/api/orgs/{orgId}/branding",
        "transport": "direct"
      },
      "cli": {
      ...
      "mcp": {
        ...
        "description": "Update the authenticated organization's brand color. Mutating: yes. Runtime identity and authorization are injected by the Rudder-managed MCP server and are not accepted as tool input. Org context: required from runtime env. Agent context: runtime env when available. Run attribution: attached from runtime env when available.",
        "inputSchema": {
          "additionalProperties": false,
          "properties": {
            "brandColor": {
    ...
    },
    {
      "api": {
        "method": "PATCH",
        "pathTemplate": "/api/projects/{project}",
        "transport": "direct"
      },
      "cli": {
        "attachesRunIdWhenAvailable": true,
...
export const RUDDER_AGENT_CONTRACT_HASH = "c90ac61bb8a56a5ef8026762f899b2f9c5e4618de5b6f6c40480a1cc5de60500";
