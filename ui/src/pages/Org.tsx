...
export function Org() {
  ...
  if (!selectedOrganizationId) {
    return <EmptyState icon={GitBranch} message="Select an organization to view the Organization Structure." />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message="No agents in the organization. Create agents to build your Organization Structure."
        />
      )}
