...
import type { CostByProviderModel, CostWindowSpendRow, QuotaWindow } from "@rudder/shared";
...
interface ProviderQuotaCardProps {
  ...
  /** organization monthly budget in cents (0 means unlimited) */
  budgetMonthlyCents: number;
  /** total organization spend in this period in cents, all providers */
