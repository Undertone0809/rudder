...
import { buildAgentMentionHref, buildAutomationMentionHref, buildChatMentionHref, buildIssueMentionHref, buildLibraryDirectoryMentionHref, buildLibraryDocMentionHref, buildLibraryEntryMentionHref, buildLibraryFileMentionHref, buildPluginMentionHref, buildProjectMentionHref } from "@rudderhq/shared";
import {
  $createParagraphNode,
...
export const LegacyMarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function LegacyMarkdownEditor({
  value,
  onChange,
  readOnly = false,
  placeholder,
