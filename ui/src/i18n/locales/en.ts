export const en = {
  ...
  "privacyTelemetry.loadFailed": "Failed to load Privacy & Telemetry settings.",
  "privacyTelemetry.updateFailed": "Failed to update telemetry consent.",
  "privacyTelemetry.mode.title": "Sharing mode",
  "privacyTelemetry.mode.description": "Anonymous and account-linked telemetry are separate consent scopes. Turning both off stops new uploads.",
  "privacyTelemetry.mode.off": "Off",
  "privacyTelemetry.mode.anonymous": "Anonymous",
  "privacyTelemetry.mode.accountLinked": "Account linked",
  "privacyTelemetry.anonymous.title": "Anonymous telemetry",
  "privacyTelemetry.anonymous.description": "Share pseudonymous installation milestones without linking them to a Rudder Account.",
  "privacyTelemetry.anonymous.toggle": "Enable anonymous telemetry",
  "privacyTelemetry.accountLinked.title": "Account-linked telemetry",
  "privacyTelemetry.accountLinked.description": "Link milestones to the signed-in Rudder Account on this device. This requires a separate explicit consent.",
  "privacyTelemetry.accountLinked.toggle": "Enable account-linked telemetry",
  "privacyTelemetry.currentMode": "Current mode: {{mode}}",
  "privacyTelemetry.disclosure.title": "Data boundary",
  "privacyTelemetry.disclosure.description": "Rudder sends bounded milestone facts, never workspace content.",
  "privacyTelemetry.disclosure.collected": "Collected",
  "privacyTelemetry.disclosure.excluded": "Not collected",
  "privacyTelemetry.delivery.title": "Installation and delivery",
  "privacyTelemetry.delivery.description": "Delivery is local-first, retryable, and scoped to the consent epoch.",
  "privacyTelemetry.delivery.installationId": "Masked installation ID",
  "privacyTelemetry.delivery.installationIdDescription": "Only the suffix is shown here; the installation secret never enters the renderer.",
  "privacyTelemetry.delivery.lastAttempted": "Last attempted upload",
  "privacyTelemetry.delivery.lastSucceeded": "Last successful upload",
  "privacyTelemetry.delivery.pending": "Pending events",
  "privacyTelemetry.delivery.coverageGap": "The local backlog cap was reached; some facts may not be exported.",
  "privacyTelemetry.delivery.lastError": "Last error",
  "privacyTelemetry.delivery.lastPayload": "Last payload",
  "privacyTelemetry.delivery.noPayload": "No payload has been prepared yet.",
  "privacyTelemetry.delivery.viewPayload": "View payload",
  "privacyTelemetry.delivery.hidePayload": "Hide payload",
  "privacyTelemetry.never": "Never",
  "privacyTelemetry.none": "None",
  "privacyTelemetry.footer": "You can revoke either consent at any time. Local facts remain in this workspace; unsent rows for the revoked scope are removed.",
  ...
  "experimental.computerUse.disabledDescription": "Adds native macOS app interaction as another Agent capability.",
  "experimental.computerUse.readyDescription": "Agents can observe and operate macOS apps on this device.",
  "experimental.computerUse.permissionDescription": "Accessibility and Screen Recording access are required.",
  "experimental.computerUse.desktopRequired": "Computer Use requires Rudder Desktop on macOS.",
  ...
  "experimental.computerUse.permissionFailed": "Failed to update Computer Use permissions.",
