export const en = {
  ...
  "experimental.computerUse.disabledDescription": "Adds native app interaction as another Agent capability.",
  "experimental.computerUse.readyDescription": "Agents can observe and operate apps on this device.",
  "experimental.computerUse.permissionDescription": "This device is not ready for Computer Use.",
  "experimental.computerUse.desktopRequired": "Computer Use requires a supported Rudder Desktop build.",
