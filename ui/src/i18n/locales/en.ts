export const en = {
  ...
  "organizationSettings.section.issues": "Issues",
  ...
  "organizationSettings.issues.archived.title": "Archived issues",
  "organizationSettings.issues.archived.description":
    "Archived issues stay out of boards, search, Messenger, and agent context. Restore or permanently delete them here.",
  "organizationSettings.issues.archived.loading": "Loading archived issues...",
  "organizationSettings.issues.archived.empty": "No archived issues.",
  "organizationSettings.issues.archived.count": "Showing {{visible}} of {{total}}",
  "organizationSettings.issues.archived.searchPlaceholder": "Search archived issues...",
  "organizationSettings.issues.archived.noResults": "No archived issues match this search.",
  "organizationSettings.issues.archived.restore": "Restore",
  "organizationSettings.issues.archived.restoreFailed": "Failed to restore issue",
  "organizationSettings.issues.archived.delete": "Delete",
  "organizationSettings.issues.archived.deleteAria": "Delete {{identifier}}",
  "organizationSettings.issues.archived.deleteFailed": "Failed to delete issue",
  "organizationSettings.issues.archived.deleteConfirmTitle": "Permanently delete archived issue?",
  "organizationSettings.issues.archived.deleteConfirmDescription":
    "Delete {{identifier}} and all issue-owned content permanently? Rudder keeps only its title and minimal deletion details so old references can report that it was deleted. This cannot be undone.",
