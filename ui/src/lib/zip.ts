...
function portableFileEntryToBytes(entry: OrganizationPortabilityFileEntry): Uint8Array {
...
export function createZipArchive(files: Record<string, OrganizationPortabilityFileEntry>, rootPath: string): Uint8Array {
