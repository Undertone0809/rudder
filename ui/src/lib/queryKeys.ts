export const queryKeys = {
  ...
  requests: {
    list: (orgId: string, status?: string, kind?: string) => ["requests", orgId, status, kind] as const,
  ...
  instance: {
    ...
    productAnalyticsSettings: ["instance", "product-analytics"] as const,
  ...
  activityRoot: (orgId: string) => ["activity", orgId] as const,
