...
export const runTranscriptFixtureEntries: TranscriptEntry[] = [
  ...
  },
  {
    ...
    toolUseId: "item_1",
    input: {
      command: "sed -n '1,220p' doc/product/GOAL.md",
  ...
  },
  {
    ...
    toolUseId: "item_2",
    input: {
      command: "sed -n '1,320p' doc/archive/SPEC-implementation.md",
      cwd: "/workspace/rudder",
    },
  },
  {
