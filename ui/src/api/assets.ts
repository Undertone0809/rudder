...
export const assetsApi = {
  uploadImage: async (orgId: string, file: File, namespace?: string) => {
    ...
    return api.postForm<AssetImage>(`/orgs/${orgId}/assets/images`, form);
  },
  ...
  uploadOrganizationLogo: async (orgId: string, file: File) => {
    ...
    const form = new FormData();
    form.append("file", safeFile);
    return api.postForm<AssetImage>(`/orgs/${orgId}/logo`, form);
  },
};
