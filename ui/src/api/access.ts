...
export const accessApi = {
  createCompanyInvite: (
    ...
    api.post<OrganizationInviteCreated>(`/orgs/${orgId}/invites`, input),
  ...
  createOpenClawInvitePrompt: (
    ...
    api.post<OrganizationInviteCreated>(
  ...
  listJoinRequests: (orgId: string, status: "pending_approval" | "approved" | "rejected" = "pending_approval") =>
    api.get<JoinRequest[]>(`/orgs/${orgId}/join-requests?status=${status}`),

  approveJoinRequest: (orgId: string, requestId: string) =>
    api.post<JoinRequest>(`/orgs/${orgId}/join-requests/${requestId}/approve`, {}),

  rejectJoinRequest: (orgId: string, requestId: string) =>
    api.post<JoinRequest>(`/orgs/${orgId}/join-requests/${requestId}/reject`, {}),
