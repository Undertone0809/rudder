 ...
 *
 * Plugin bundles are built with `external: ["@rudder/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@rudder/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@rudder/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@rudder/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@rudder/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@rudder/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@rudder/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
