...
import { PLUGIN_LAUNCHER_BOUNDS } from "@rudder/shared";
import type {
...
function buildLauncherHostContext(
  ...
  return {
    ...
    orgPrefix: context.orgPrefix ?? null,
 ...
 * consume this ambient context so the bridge can forward organization/entity scope
