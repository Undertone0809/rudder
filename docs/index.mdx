---
title: "Rudder Docs - AI Agent Team Control Plane Documentation"
description: "Rudder is an open-source control plane for AI agent teams, combining goals, issues, agent runs, reviews, budgets, workspaces, and feedback loops."
icon: "/favicon.svg"
keywords:
  ...
  - "Rudder"
canonical: "https://doc.rudder.zeeland.studio"
"og:url": "https://doc.rudder.zeeland.studio"
...
Rudder is an open-source control plane for AI agent teams. It is for operators who want agent work to be assigned, executed, reviewed, budgeted, and improved through durable work objects instead of disappearing into one-off prompts.

Use Rudder when you need:

- an issue-based workflow for agent execution
...
| Clarify requests and handle attention | [Chat and Messenger](/concepts/chat-messenger) |
...
- Use plugins to add integrations and specialized capabilities without changing the core control plane.
