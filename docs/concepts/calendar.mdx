---
title: "Calendar"
description: "Use Rudder Calendar to inspect AI agent run history, issue work, cost signals, and human checkpoints over time."
icon: "calendar-days"
keywords:
  - "agent run history"
  - "AI agent calendar"
...
| Block | Meaning |
| --- | --- |
| Agent run history | Actual agent runs tied to agents, issues, and projects |
...
<CardGroup cols={2}>
  ...
  <Card title="Agents" icon="bot" href="/concepts/agents">
    Understand the agent runs Calendar can reflect.
  </Card>
</CardGroup>
