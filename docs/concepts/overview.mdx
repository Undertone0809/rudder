...
| Govern spend, approvals, and attention | Operating layer |
...
The operating layer keeps approvals, budgets, activity, run intelligence, dashboard health, Calendar history, and Inbox attention visible.
