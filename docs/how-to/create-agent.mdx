...
A new organization includes a default Operator Assistant. Use it for the first
real workflow.
...
The default agent's name is generated during onboarding. Its starting title is
`Operator Assistant`: it helps capture requests, shape issues, route work,
summarize evidence, and preserve useful lessons.
