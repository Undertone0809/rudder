...
During onboarding, Rudder checks whether each local CLI is actually installed on the Rudder host. Missing local runtimes are shown as unavailable and link to their official installation page instead of being selectable.
