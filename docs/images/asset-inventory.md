...
| `chat-create-issue-proposal.png` | Chat task thread showing an operator-requested issue proposal as optional structure. | `docs/concepts/chat.mdx`, `docs/get-started/first-organization.mdx` | Desktop crop from the Messenger chat surface. Keep the proposal block and composer context visible. |
...
| `visualize-skill-agent-operations.png` | Real Codex-generated Visualize artifact showing an eight-week agent operations decision dashboard. | `docs/releases.mdx`, `docs/concepts/skills.mdx`, and their Chinese counterparts. | Inline artifact crop, 682 x 656. Keep the English chart labels, target lines, summary cards, and failure mix visible. |
