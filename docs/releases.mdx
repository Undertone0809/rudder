...
<Update label="August 14, 2026" description="v0.7.6" tags={["Fixed"]}>
...
<Update label="August 14, 2026" description="v0.7.5" tags={["Fixed"]}>
...
<Update label="August 13, 2026" description="v0.7.4" tags={["New","Improved","Fixed"]}>

## v0.7.4

[GitHub Release](https://github.com/Undertone0809/rudder/releases/tag/v0.7.4)

This release adds experimental Computer Use and Plugin V1, gives Agents clearer human-help and recovery paths, and improves Chat, Goals, transcripts, and Issue timelines.
