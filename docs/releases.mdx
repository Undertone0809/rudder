...
This page focuses on changes you can see or use. For prerelease builds and
maintainer details, see [GitHub Releases](https://github.com/Undertone0809/rudder/releases).

Release entries preserve the product names and historical terminology used
when each version shipped. For current product guidance, use the Concepts,
How-to, and Reference pages in this site. Future release entries should use
current navigation names and link to the relevant guide when a term may be
ambiguous.
