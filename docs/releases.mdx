...
- Improved operating-layer performance and operator safeguards with bounded navigation payloads and stricter spawned lifecycle gates.
...
- Improved operating-layer performance with cheaper Messenger summaries, sidebar badge aggregation, monthly cost spend rollups, and approval summary indexing.
